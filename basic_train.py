...
class Recorder(LearnerCallback):
    ...
    def plot(self, skip_start:int=10, skip_end:int=5, suggestion:bool=False, return_fig:bool=None, return_lr:bool=False, slc:bool=False,
        ...
        if ifnone(return_fig, defaults.return_fig): return fig
        if return_lr and slc: return slice(lrs[mg], lrs[ml]/10)
        elif return_lr and not slc: return lrs[mg]
        if not IN_NOTEBOOK: plot_sixel(fig)
